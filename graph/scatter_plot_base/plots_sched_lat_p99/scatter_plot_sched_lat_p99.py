#!/usr/bin/env python3
"""
IEEE Two-Column Format Correlation Plot Generator
==================================================
Creates publication-quality scatter plots showing Spearman correlations
between kernel metrics and application latency for IEEE conference papers.

Author: Ali
Purpose: QoS prediction research visualization
"""
...
INPUT_CONFIG = {
    ...
    'kernel_metric_file': 'sched_lat_latency_p99_us.csv',
...
PLOT_CONFIG = {
    ...
    'Hotel_P99_ms': {
        ...
        'output_filename': 'hotel_schedlat_correlation.pdf',
        'show_correlation_text': True,
    ...
    'Feedback_P99_ms': {
        ...
        'output_filename': 'feedback_schedlat_correlation.pdf',
        'show_correlation_text': True,
        'correlation_position': 'upper left',
    },
}
